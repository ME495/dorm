...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { lecid: @lecture.lecid, suite: @lecture.suite, text: @lecture.text, time: @lecture.time, type: @lecture.type, userid: @lecture.userid } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { lecid: @lecture.lecid, suite: @lecture.suite, text: @lecture.text, time: @lecture.time, type: @lecture.type, userid: @lecture.userid } }
